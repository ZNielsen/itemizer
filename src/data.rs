...
pub trait Itemizer {
    ...
    fn purchases_iter(&self) -> std::slice::Iter<'_, Purchase>;
    fn purchases(&self) -> &Purchases;
}
...
pub struct Purchase {
    ...
    pub tags: Vec<String>,
    pub price: f64,
    pub date: NaiveDate, // Date of image file
...
impl Purchases {
    pub fn init() -> Self {
        ...
        for line in text.lines() {
            ...
            let date = parts[0].parse().unwrap();
            let price = parts[1].parse().unwrap();
...
impl FileItemizer {
    pub fn new() -> Self {
        Self {
            ...
            current_date: NaiveDate::from_ymd_opt(2001, 9, 11).unwrap(),
        }
    }
